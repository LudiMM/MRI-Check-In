...
class Screen6 extends React.Component {
  ...
  onKeyPress = button => {
    ...
    if (button === '{enter}') {
      this.props.storeLastName(this.state.input);
      this.props.Next();
    }
...
export default withStyles(styles)(Screen6);
