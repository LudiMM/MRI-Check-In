...
class Screen9 extends React.Component {
  ...
  onKeyPress = button => {
    ...
    if (button === '{enter}') {
      this.props.storeAddress(this.state.input);
      this.props.Next();
    }
...
export default withStyles(styles)(Screen9);
